...
- **Linux release compatibility**: publish Linux release archives from musl
  targets so the shipped `gofs` binaries execute correctly in Alpine-based
  containers, including Cloud Eric's runtime image.
